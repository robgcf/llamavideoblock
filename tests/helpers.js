...
/** The fixture server's hostname, as LlamaBlock would store it in the whitelist. */
...
/** @typedef {{ extension: Extension }} LlamaBlockFixtures */
...
export const test = base.extend(
  /** @type {import('@playwright/test').Fixtures<LlamaBlockFixtures, {}, BaseTestArgs, BaseWorkerArgs>} */ ({
    /**
    ...
    extension: async ({}, use) => {
      const profile = await mkdtemp(join(tmpdir(), 'llamablock-'));
