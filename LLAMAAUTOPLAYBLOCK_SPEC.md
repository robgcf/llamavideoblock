# LlamaAutoPlayBlock — Chrome Extension Spec
...
### Toolbar Popup
Clicking the LlamaAutoPlayBlock icon in the Chrome toolbar opens a small popup with:
...
- LlamaAutoPlayBlock logo/name in the header
...
### Toolbar Icon States
- **Normal (blocking active):** full color LlamaAutoPlayBlock icon
...
- Extension name: **LlamaAutoPlayBlock**
