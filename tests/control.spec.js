 ...
 * The control group.
 *
 * These tests prove the fixtures genuinely autoplay when LlamaAutoPlayBlock stands down. Without
...
test('autoplays normally when the master toggle is off (spec §5)', async ({ extension }) => {
  ...
  // The site's own markup is left untouched when LlamaAutoPlayBlock stands down.
